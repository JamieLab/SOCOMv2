...
inps = 'E:/SOCOMV2/EX2/flux'
start_yr = 1970
end_yr = 2022
log,lag = du.reg_grid(lat=1,lon=1)
from Data_Loading.ERA5_data_download import era5_average,era5_daily,era5_wind_time_average
...
era5_average(loc = "F:/Data/ERA5/DAILY/monthly", outloc=os.path.join(inps,'ws'),log=log,lag=lag,var='ws',start_yr = start_yr,end_yr =end_yr)
era5_average(loc = "F:/Data/ERA5/DAILY/monthly", outloc=os.path.join(inps,'ws2'),log=log,lag=lag,var='ws2',start_yr = start_yr,end_yr =end_yr)
