...
if __name__ == '__main__':
    ...
    model_save_loc = 'E:/SOCOMV2/EX4/UExPFNNU/no_trend_v1-1'
    ...
    if create_inp:
        ...
        ['model_full','fco2',os.path.join(model_location,'fco2','%Y_%m*.nc'),0],
        ['model','xco2_clim',os.path.join(model_location,'xco2_clim','%Y_%m*.nc'),1],
        ...
        rean.model_fco2_append(socat_file,data_file,start_yr = start_yr,end_yr=end_yr,name = 'model',ref_yr=1982,var_name = 'fco2')
        # #
        # #
        ...
        som.som_feed_forward(model_save_loc,data_file,['Takahashi_taka','model_sst','model_sss','model_mld'])
    ...
    if run_neural:
        ...
        nnt.driver(data_file,fco2_sst = 'model', prov = 'prov_smoothed',var = ['model_sst','model_xco2_clim','model_sss','model_mld','model_sst_anom','model_xco2_clim_anom','model_sss_anom','model_mld_anom'],
